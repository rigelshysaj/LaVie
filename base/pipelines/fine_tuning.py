...
def load_model_for_inference(device, args):
    ...
    return unet, tokenizer, text_encoder, vae, clip_model, clip_processor, scheduler
...
def main(args):
    ...
    video = videogen_pipeline("a cat meow from the screen", video_length=16, height=320, width=512, num_inference_steps=50, guidance_scale=7.5).video
